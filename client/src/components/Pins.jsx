      ...
      <div className="card">
        ...
        <div className="empty-state">
          ...
          <p className="empty-text" style={{ marginTop: "0.4rem", fontSize: "0.8rem" }}>
            Convert a currency or time pair and tap "Save this pair" to keep it here.
          </p>
  ...
  return (
    <div className="card">
      <div className="section-header">
        ...
        <span style={{ fontSize: "0.78rem", color: "var(--text-muted)" }}>{pins.length} saved</span>
      </div>
          ...
          <div className="pin-list">
            {timePins.map(pin => (
              <div className="pin-item" key={pin}>
                ...
                <button className="btn-unpin" onClick={() => onRemove(pin)}>✕</button>
              </div>
            ))}
          </div>
        </div>
